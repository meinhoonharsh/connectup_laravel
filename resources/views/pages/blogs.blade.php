                ...
                <div class="section-pager-bar">
                    ...
                    <div class="section-pager">
                        ...
                        @foreach (range(1, $blogs->lastPage()) as $page)
                            <div class="section-pager-item @if ($page == $blogs->currentPage()) active @endif">
                                <!-- SECTION PAGER ITEM TEXT -->
                                <a href="{{ $blogs->url($page) }}" class="section-pager-item-text">{{ $page }}</a>
                                <!-- /SECTION PAGER ITEM TEXT -->
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="section-pager-controls">
                        ...
                        <a class="slider-control left @if ($blogs->currentPage() != 1) active @else disabled @endif"
                        ...
                        <a class="slider-control right  @if ($blogs->currentPage() != $blogs->lastPage()) active @else disabled @endif"
